...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/javascripts/dragger.js":[function(require,module,exports) {
"use strict";
...
var startAtHandle = function startAtHandle() {
  return document.querySelector("#startAtHandle");
};

var endAtHandle = function endAtHandle() {
  return document.querySelector("#endAtHandle");
};

function number(object) {
  var int = Number(object);
...
function init() {
  (0, _dragger.default)(); // initializeDraggable()
}
