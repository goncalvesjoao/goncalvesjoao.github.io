...
Please take a look at [{{ site.categories.api.first.title }}]({{ site.base_path }}{{ site.categories.api.first.url }}) 
or jump right into [Usage]({{ site.base_path }}{{ site.categories.usage.first.url }}) if you'd like.